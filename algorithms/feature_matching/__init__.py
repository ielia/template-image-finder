...
from .detectors import DETECTOR_ORB, DETECTOR_SIFT, DETECTOR_PARAM_SPECS
...
ALGORITHM_PARAMS = {
    ALGORITHM_BF: {
        'detector': {'type': str, 'options': [DETECTOR_ORB, DETECTOR_SIFT], 'default': DETECTOR_ORB},
    ...
    ALGORITHM_FLANN: {
        'detector': {'type': str, 'options': [DETECTOR_ORB, DETECTOR_SIFT], 'default': DETECTOR_SIFT},
        'matching_method': {'type': str, 'options': [MATCHING_METHOD_BEST, MATCHING_METHOD_KNN, MATCHING_METHOD_RADIUS],
